...
public class SampleSchedulerJob implements Job{
    
    private static final Logger LOG = LoggerFactory.getLogger(SampleSchedulerJob.class);
    ...
    protected void addSchedulerJob(SchedulerConfig config) {
        LOG.info("======= SAMPLE SCHEDULER JOB STARTED ===========");
